...
<fieldset>
    ...
    <div class="popupUpdatePost">
        ...
        <form method="POST" action="index.php?action=formUpdatePost"  class="formUpdatePost">
            ...
            <label class="label_author_update_post stl-label" for="author">Modifier l'auteur de l'article : </label><br /> 

            <input type="text" id="author" class="input_field update_author style" name="author" value="<?= htmlspecialchars($post['author']) ?>" autofocus/><br /><br />

            <label class="label_title_update_post stl-label" for="title">Modifier le titre de l'article : </label><br /> 

            <input type="text" id="title" class="input_field update_title style" name="title" value="<?= htmlspecialchars($post['title']) ?>" /><br /><br />

            <label class="label_content_new_post stl-label" for="content">Modifier l'article : </label><br /><br /> 
            ...
            <label for="submit_update_post" class="stl-label">Modifier l'article : </label><br />
